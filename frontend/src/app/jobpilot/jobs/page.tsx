        ...
        <div className="flex flex-col gap-6 lg:col-span-5 lg:row-span-1">
            ...
            <div className="flex flex-col gap-2 lg:col-span-4 lg:row-span-1">
                <div className="flex justify-between items-center gap-2">
                    <div>
                        <input
                            className="w-96 border-black rounded-md border-2 p-2.5"
                ...
                <table className="border-collapse border-4 border-black">
                    ...
                    <tr>
                        ...
                        <th className="border-4 border-black p-2 whitespace-nowrap">Statut</th>
                    ...
                    {isLoading ? (
                        <tr>
                            <td colSpan={9} className="text-center p-2">Loading...</td>
                        </tr>
                    ) : isError ? (
                            <tr>
                                <td colSpan={9} className="text-center p-2">Error loading data</td>
                            </tr>
                        ) :
